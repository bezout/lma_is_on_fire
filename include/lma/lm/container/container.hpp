...
#include <cstddef>
#include <lma/lm/trait/accessor.hpp>
#include <lma/lm/trait/adl.hpp>
...
////////////////////////////////////////////////////////
  template<class Float> void apply_small_increment(Float& obj, Float delta, const numeric_tag<0> &, const Adl&, typename boost::enable_if<boost::is_floating_point<Float>>::type* =0)
  {
    obj += delta;
  }
...
////////////////////////////////////////////////////////
  ...
  namespace detail
  {
    ...
    template<class Obj, class Float, int I> void internal_apply_small_increment(Obj& o, Float flt, const numeric_tag<I> &tag)
    {
