...
#include <lma/lm/function/derivative/default_derivative.hpp>
#include <lma/lm/ba/fonctorba.hpp>
#include <lma/lm/omp/omp.hpp>
...
namespace lma
{
  namespace detail
  {
    ...
    template<class Tag, class Bundle, class Ba, class MapErreur, class Medianes> struct FillHessien32
    {
      ...
      template<class Obs> void sequential(ttt::wrap<Obs> const &)// DerivativeTag = NumericForward || NumericCentral || Analytical
      {
