...
namespace ttt
{
  template<class A, class B, class C, int I> struct Name<lma::ImplicitSchur<A,B,C,lma::Int<I>>> { static std::string name(){ return "ImplicitSchur<" + ttt::name<B>() + "," + ttt::name<C>() + "," + lma::to_string(I) + ">"; } };
}
