...
#include "../levmar.hpp"
#include <lma/lm/ba/initialize.hpp>
#include <lma/lm/ba/compute_s.hpp>
#include <lma/lm/bundle/make_sparse_indice.hpp>
#include "schur.hpp"
#include "implicit_schur.hpp"
#include <boost/fusion/include/pair.hpp>
#include <lma/lm/ba/tuple_to_mat.hpp>
...
namespace ttt
{
  template<class A, class B, class C, int K> struct Name<lma::ExplicitSchur<A,B,C,lma::Int<K>>> { static std::string name(){ return "ExplicitSchur<" + ttt::name<B>() + "," + ttt::name<C>() + "," + lma::to_string(K) + ">"; } };
}
